...
public class InputController : MonoBehaviour
{
  ...
  public bool AutoRun     { get { return mAutoRun; } set { mAutoRun = value; } }
  ...
  private bool [] inventorySelection = new bool[6] { false, false, false, false, false, false };
  public bool [] InventorySelection { get { return inventorySelection; } }
  ...
  {
    // Update Mouse Input
    mMouseHorz = Input.GetAxis("Mouse X") * Time.deltaTime * HorizontalSensitivity;
    mMouseVert = Input.GetAxis("Mouse Y") * Time.deltaTime * VerticalSensitivity * -1.0f;
    ...
    if (toggleAim)
    {
      mIsAiming = Input.GetButtonDown("Aim") ? !mIsAiming : mIsAiming;
    }
    else
    ...
    inventorySelection[1] = Input.GetButtonDown("InventorySlot1");
    inventorySelection[2] = Input.GetButtonDown("InventorySlot2");
    inventorySelection[3] = Input.GetButtonDown("InventorySlot3");
    inventorySelection[4] = Input.GetButtonDown("InventorySlot4");
    inventorySelection[5] = Input.GetButtonDown("InventorySlot5");
    inventorySelection[0] = Input.GetButtonDown("InventorySlot6");
